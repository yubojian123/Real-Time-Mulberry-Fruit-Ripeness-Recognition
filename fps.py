...
if __name__ == '__main__':
    ...
    parser.add_argument('--weights', type=str, default='runs/detect/train4/weights/best.pt', help='trained weights path')
...
# Size: 6.0M (Batch size: 1) Latency: 0.01099s ± 0.00102s FPS: 91.0
